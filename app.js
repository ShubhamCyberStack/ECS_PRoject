...
const cars = [
    ...
    { id: 21, name: "Rivian", model: "R1T", version: "Quad-Motor AWD", colors: ["Rivian Blue", "Canyon Red"], specs: "835 hp, 0-60 in 3.0s", topSpeed: "110 mph", tires: "20\" All-Terrain", body: "Pickup Truck", price: "$87,000", unitsSold: "40,000", safetyRating: "5-Star", img: "https://images.unsplash.com/photo-1614200187524-dc4b8fa2393a?auto=format&fit=crop&w=500&q=80" },
    { id: 22, name: "Lucid", model: "Air", version: "Sapphire", colors: ["Sapphire Blue"], specs: "Three Motors, 1,234 hp", topSpeed: "205 mph", tires: "Aero Sapphire", body: "Luxury Sedan", price: "$249,000", unitsSold: "5,000", safetyRating: "5-Star", img: "https://images.unsplash.com/photo-1621135802920-133df287f89c?auto=format&fit=crop&w=500&q=80" },
    ...
    { id: 24, name: "Volkswagen", model: "Golf R", version: "20th Anniversary", colors: ["Lapiz Blue Metallic", "White"], specs: "2.0L Turbo, 315 hp", topSpeed: "155 mph", tires: "19\" Estoril", body: "Hatchback", price: "$45,000", unitsSold: "15,000", safetyRating: "5-Star", img: "https://images.unsplash.com/photo-1611859328053-3cbc9f9399f4?auto=format&fit=crop&w=500&q=80" },
